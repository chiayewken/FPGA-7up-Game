...
module multi_dec_ctr_4 (
  ...
  reg [(3'h4+0)-1:0] M_dctr_resetSignal;
  reg [(3'h4+0)*4-1:0] M_dctr_digitsOverride;
  ...
  for (GEN_dctr0=0;GEN_dctr0<3'h4;GEN_dctr0=GEN_dctr0+1) begin: dctr_gen_0
    decimal_counter_10 dctr (
      ...
      .resetSignal(M_dctr_resetSignal[GEN_dctr0*(1)+(1)-1-:(1)]),
      .digitsOverride(M_dctr_digitsOverride[GEN_dctr0*(3'h4)+(3'h4)-1-:(3'h4)]),
  ...
  always @* begin
    ...
    M_dctr_resetSignal = {3'h4{resetSignal}};
    M_dctr_digitsOverride = digitsOverride;
  end
endmodule
